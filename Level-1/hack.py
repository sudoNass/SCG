...
class TestOnlineStore(unittest.TestCase):
    ...
    def test_4(self):
        ...
        payment = c.Item(type='payment', description='invoice_4', amount=1000, quantity=1)
        reimbursement = c.Item(type='payment', description='reimbursement_4', amount=-1000, quantity=1)
